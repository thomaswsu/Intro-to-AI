...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        for action in actions:
          ...
          if bestQValue == None or QValue > bestQValue:
            bestQValue = QValue
        return(bestQValue)
    ...
    def getAction(self, state):
        """
          ...
          HINT: You might want to use util.flipCoin(prob) # Wat
    ...
    def update(self, state, action, nextState, reward):
        ...
        # get the highest Q-value of the next state with every of its legal actions
          ...
          for nextAction in nextActions:
              ...
              if nextBestQValue == None or nextQvalue > nextBestQValue:
                  nextBestQValue = nextQvalue
                
        # calculate the sample
        sample = reward + self.discount * nextBestQValue
