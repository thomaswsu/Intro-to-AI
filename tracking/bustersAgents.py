...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for estimatedDistance in livingGhostPositionDistributions:
            bestPostion = None
            bestValue = None
            for postion, value in estimatedDistance.items():
                if bestValue is None or value > bestValue:
                    bestPostion = postion
                    bestValue = value
            distance = self.distancer.getDistance(pacmanPosition, bestPostion) # this is such a weird method...
            if closestGhostDistance == None or distance < closestGhostDistance:
                closestGhostDistance = distance
                closestGhostPosition = bestPostion
        
        optimalAction = None 
        optimalDistance = None # optimal distance to action
        for action in legal:
            ...
            if optimalDistance == None or distance < optimalDistance:
